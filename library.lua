...
function Library:Create(ScriptName)
    ...
    function UI:Tab(TabName)
        ...
        Insert:UIListLayout(TabContainer, "Vertical", 3)
        Insert:UIPadding(TabContainer, 5)
        ...
        local UIL = TabContainer:FindFirstChild("UIListLayout")
        local UIP = TabContainer:FindFirstChild("UIPadding")
        ...
        function Features:Button(ButtonName, Callback)
            local Button = Create("TextButton", TabContainer, {
                Name = ButtonName,
        ...
        function Features:Box(BoxName, Callback)
        ...
        function Features:Toggle(ToggleName, Callback, Options)
            local Enabled = false
        ...
        function Features:Slider(SliderName, Callback, Options)
            local Min = 0
            local Max = 1
            local Precise = false
            local Enabled = false
        ...
        function Features:Dropdown(DropdownName, Callback, Data, Options)
            ...
            function DropdownFeatures:UpdateData()
        ...
        function Features:Label(LabelName, LabelText)
